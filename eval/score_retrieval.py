...
Computes retrieval precision@k from the hand-labels produced by
label_retrieval.py. This is the number you put in your README:
"X% of retrieved chunks were actually relevant to the question."
...
def precision_at_k(chunk_labels: list[dict], k: int | None = None) -> float:
    """
    Fraction of the top-k retrieved chunks that were labeled relevant.
    If k is None, uses however many chunks were actually labeled for
    that question (handles partially-labeled questions gracefully).
    """
