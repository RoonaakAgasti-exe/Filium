...
load_dotenv()
EDGAR_USER_AGENT = os.getenv("EDGAR_USER_AGENT", "Filium dev dev@example.com")
...
def get_filing_index(cik: str, filing_type: str = "10-K", count: int = 1) -> list[dict]:
    ...
    for i, form in enumerate(recent["form"]):
        if form == filing_type:
            ...
            matches.append({"filing_date": filing_date, "accession_number": accession_number, "url": doc_url})
