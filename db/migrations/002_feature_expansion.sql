...
ALTER TABLE predictions ADD COLUMN IF NOT EXISTS model_version_id INT
UPDATE predictions
...
CREATE TABLE IF NOT EXISTS alerts (
    ...
    ticker TEXT NOT NULL REFERENCES companies(ticker),
    rule_type TEXT NOT NULL CHECK (rule_type IN ('prediction_flip', 'price_move', 'sentiment_below', 'sentiment_above', 'confidence_above')),
