...
logger = logging.getLogger("filium.market_data")
WEB_TIMEOUT = 8
_BROWSERISH_UA = "Mozilla/5.0 (compatible; Filium/1.0)"
...
def _live_quote(ticker: str) -> dict | None:
    ...
    if alpaca_client.is_configured():
        try:
            quote = {"price": alpaca_client.get_latest_price(ticker), "source": "alpaca", "as_of": None}
